...
test('customer debug 3', async ({ page }) => {
  ...
  await page.locator('input[type="text"]').first().fill(`REF-TEST-12345`);
  ...
  console.log('Has PKR 5,000:', html.includes('PKR 5,000'));
  console.log('Has 5000:', html.includes('5000'));
  console.log('Has REF-TEST-12345:', html.includes('REF-TEST-12345'));
  console.log('Has No payments:', html.includes('No payments recorded yet'));
  await page.screenshot({ path: 'tmp-customer-debug3.png', fullPage: true });
});
